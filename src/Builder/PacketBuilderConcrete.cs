...
namespace Kamael.Packets.Builder
{
    ...
    /// </summary>
    public class PacketBuilderConcrete : PacketBuilder
    {
        private readonly L2RPacket Pkt = new L2RPacket();
        private readonly ushort PacketID = 0;

        public override void BuildPart()
        {
            //Packet.Parts.Add("Adding part #" + (part++));
        }

        public override L2RPacket Construct()
        {
            return Pkt;
        }

        public override IL2RPacket GetPacket(ushort PacketID, IL2RPacket RawPacket)
        {
            switch (PacketID)
            {
                case 0:     // 0x1
                ...
                case 203:       // 0xCC
                                //return new StatusMovement((L2RPacket)RawPacket);//"PktPlayerMoveListNotify";
