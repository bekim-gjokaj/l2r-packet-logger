    ...
    public class ConcretePacketFactory : PacketFactory
    {
        public override IL2RPacket GetPacket(ushort PacketID, IL2RPacket packet)
        {
            switch (PacketID)
            {
                ...
                case 0: break;//return new PacketVersion(packet);    // 0x1 //result = "PktVersion";
                case 1: break;//return PacketVersionResult(packet);    // 0x2 //result = "PktVersionResult";


                case 2: break; // 0x3 //result = "PktLogin"; 
                case 3:     // 0x4 //result = "PktLoginResult";
                    break;
